...
export default function ItemGrid(props:props){
        ...
        return (
            <a className="collection-item row">
                    ...
                    <button className={estiloBotao} type="submit" name="action" onClick={(e:any) => props.seletorView('Associar', e)}>Associar
                        <i className="material-icons right">device_hub </i>
                    </button>
                    <a className="col s1 right"> </a>
                    <button className={estiloBotao} type="submit" name="action" onClick={(e:any) => props.seletorView('Cadastros' + tela, e)}>Editar
