...
export default function ListaProdutoServico(props:props) {
        ...
        return (
            <div className="collection">
                ...
                <ItemGrid tema={props.tema} nome=' 1' tipo={props.tipo} id='' seletorView = {props.seletorView}/>
                <ItemGrid tema={props.tema} nome=' 2' tipo={props.tipo} id='' seletorView = {props.seletorView}/>
                <ItemGrid tema={props.tema} nome=' 3' tipo={props.tipo} id='' seletorView = {props.seletorView}/>
                <ItemGrid tema={props.tema} nome=' 4' tipo={props.tipo} id='' seletorView = {props.seletorView}/>
